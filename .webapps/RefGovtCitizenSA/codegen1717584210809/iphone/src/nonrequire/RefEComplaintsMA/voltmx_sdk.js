 ...
 */
 ...
 voltmx.sdk.VMXObj.getPendingRecordsForUpload = function(vmxObj, options, successCallback, failureCallback) {
     ...
     voltmx.sdk.logsdk.trace(" Entering " + LOG_PREFIX);
     var syncCallback = voltmx.sdk.OfflineObjects.createSyncCallback("Fetching pending records for upload of object " + vmxObj.name + " success", successCallback, "Fetching pending records for upload of object " + vmxObj.name + " object failed", failureCallback);
     var sdkObjectSync = vmxObj.getSdkObjectSync();
 ...
 voltmx.sdk.VMXObj.getBinary = function(vmxObj, options, fileDownloadStartedCompletionBlock, chunkDownloadCompletedCompletionBlock, streamDownloadCompletionBlock, fileDownloadCompletedCompletionBlock, downloadFailureCompletionBlock) {
     ...
     voltmx.sdk.logsdk.trace("Entering " + LOG_PREFIX);
     var binaryCallback = voltmx.sdk.OfflineObjects.createVoltmxBinaryDownloadCallback("Get binary on " + vmxObj.name + " object started", fileDownloadStartedCompletionBlock, "Get binary on " + vmxObj.name + " object: chunk download completed", chunkDownloadCompletedCompletionBlock, "Get binary on " + vmxObj.name + " object: stream download completed", streamDownloadCompletionBlock, "Get binary on " + vmxObj.name + " object: file download completed", fileDownloadCompletedCompletionBlock, "Get binary on " + vmxObj.name + " object failed", downloadFailureCompletionBlock);
     var sdkObjectSync = vmxObj.getSdkObjectSync();
