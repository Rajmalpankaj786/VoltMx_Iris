...
voltmx.ui = {
    Widget: function(bconfig, lconfig, pspconfig) {
       ...
       this.flexblur = bconfig.blur || {
        ...
        this.layouttype = lconfig.layoutType || voltmx.flex.VBOX_LAYOUT;
        this.layoutmeta = lconfig.layoutMeta;
        this.gridCell = lconfig.gridCell;
        this.onhover = pspconfig.onHover;
        this.cursortype = pspconfig.cursorType;
    },
...
voltmx.ui.Widget.prototype.setGetterSetter = function() {
    ...
    defineSetter(this, "hoverSkin", function(val) {
        ...
        this.hoverskin = val;
        voltmx.model.updateView(this, "hoverskin", val, oldvalue);
    });
    ...
    defineSetter(this, "onHover", function(val) {
        this.onhover = val;
    ...
    defineGetter(this, "cursorType", function() {
        return this.cursortype;
    });

    defineSetter(this, "cursorType", function(val) {
        this.cursortype = val;
        voltmx.model.updateView(this, "cursortype", val);
    });
};
