...
voltmx.ui.Form2 = function(bconfig, lconfig, pspconfig) {
    ...
    this.headers = bconfig.headers && bconfig.headers.splice(0, bconfig.headers.length); 
    this.footers = bconfig.footers && bconfig.footers.splice(0, bconfig.footers.length);
    ...
    this.breakpoints = bconfig.breakpoints || pspconfig.breakpoints;
    this.onbreakpointhandler = bconfig.onBreakpointHandler || pspconfig.onBreakpointHandler;
    this.onbreakpointchange = bconfig.onBreakpointChange || pspconfig.onBreakpointChange;
    this.onresize = bconfig.onResize || pspconfig.onResize;
...
voltmx.ui.Form2.prototype.setGetterSetter = function() {
    ...
    defineGetter(this, "onBreakpointHandler", function() {
        return this.onbreakpointhandler;
    });
    defineSetter(this, "onBreakpointHandler", function(val) {
        this.onbreakpointhandler = val;
    });
    defineGetter(this, "onBreakpointChange", function() {
        return this.onbreakpointchange;
    });
    defineSetter(this, "onBreakpointChange", function(val) {
        this.onbreakpointchange = val;
    });
    defineGetter(this, "onResize", function() {
        return this.onresize;
    });
    defineSetter(this, "onResize", function(val) {
        this.onresize = val;
    });
