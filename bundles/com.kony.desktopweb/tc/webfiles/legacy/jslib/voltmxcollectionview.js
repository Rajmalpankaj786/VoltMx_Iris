...
$KW.CollectionView = (function() {
    ...
    var module = {
        ...
        initializeView: function(formId) {
            ...
            var scrollNodes = document.querySelectorAll("#" + formId + " div[kwidgettype='CollectionView']");
        ...
        generateCollectionView: function(widgetModel, context) {
            ...
            widgetModel.scrolldirection = scrolldirection;
            widgetModel.enableScrolling = true;
            style = ((scrolldirection == "both") ? "overflow:auto;" : (scrolldirection == "horizontal" ? "overflow-x:auto;overflow-y:hidden;" : scrolldirection == "vertical" ? "overflow-y:auto;overflow-x:hidden;" : "overflow:hidden;"));
        ...
        scrollToItemAtIndex: function(CollecetionViewModel, itemObject, animate) {
            ...
            _setTopLeftToNode(CollecetionViewModel, cvNode, element.offsetLeft, element.offsetTop); 
        }
    };
    ...
    module.Skin = {
        ...
        applyWidgetFocusSkin: function(widgetData, childModel, widgetModel) {
            ...
            var hoverSkin = childModel.hoverskin;
            if(widgetData && widgetData.hoverSkin) {
                hoverSkin = widgetData.hoverSkin || widgetData.hoverskin;
            }
            if(hoverSkin) {
                var classSelector = "";
                if(widgetModel.hasSections) {
                    classSelector = "#" + gridId + " div[secindex='" + childModel.rowContext.sectionIndex + "," + childModel.rowContext.itemIndex + "'] #" + childId + ":hover";
                } else {
                    classSelector = "#" + gridId + " div[index='" + childModel.rowContext.itemIndex + "'] #" + childId + ":hover";

                }
                $KW.skins.applyStyle(hoverSkin, classSelector, widgetModel.wType);
            }
        },
