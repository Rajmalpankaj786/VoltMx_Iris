...
$KW.Scroller = (function() {
    ...
    var module = {
        ...
        destroyListBoxEditableInstances: function() {
            var listBoxEditableInstances = $KG["listBoxEditableInstances"];
            for (var i = 0; i< listBoxEditableInstances.length; i++) {
                $KW.Scroller.destroyInstance(listBoxEditableInstances[i]);
            }
        ...
        initializePageViews: function(formId) {
            ...
            if($KG["disableTransition"])
                return;
            var swipeElements = document.querySelectorAll("#" + formId + " div[name='touchcontainer_Segment'], #" + formId + " div[name='touchcontainer_Tabpane']");
